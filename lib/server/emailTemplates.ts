...
export const EMAIL_CATALOG: Record<TransactionalEmailKey, EmailDefinition> = {
  ...
  availability_opened: { recipient: 'candidate', trigger: 'availability.opened', timing: 'Straks', subjectDa: 'En profil på din shortlist har åbnet en ny tid', previewDa: 'Se den nye 60-minutters sessionstid.', ctaDa: 'Se profil og tider' },
