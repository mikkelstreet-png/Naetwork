...
export const t: Record<Lang, Record<string, string>> = {
  da: {
    ...
    'footer.legal': 'Naetwork er et uafhængigt initiativ. Eventuelle donationer og platformgebyrer beskrives transparent, før en session bookes.',
  ...
  en: {
    ...
    'footer.legal': 'Naetwork is an independent initiative. Any donations and platform fees are described transparently before a session is booked.',
