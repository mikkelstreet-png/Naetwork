      ...
      <section className="mx-auto grid max-w-7xl items-center gap-8 px-5 py-10 lg:grid-cols-[1.04fr_.96fr] lg:py-20">
        <div>
          ...
          <div className="mt-8 rounded-[28px] border border-slate-200 bg-white p-4 shadow-sm md:p-5">
            <p className="mb-3 text-sm font-black text-[#071527]">Hvad skal du have lavet?</p>
            ...
            <p className="mt-3 text-xs font-bold text-slate-500">Gratis at starte · Tager under 2 minutter · Ingen binding</p>
          </div>
        ...
        <Panel dark className="lg:p-8">
          <div className="flex items-start justify-between gap-6"><div><p className="text-sm font-black uppercase tracking-[.2em] text-emerald-200">Det du får</p><h2 className="mt-3 text-3xl font-black tracking-tight">Fra idé til brief, før du vælger specialist</h2></div><Badge dark>Early access</Badge></div>
          <div className="mt-7 grid gap-3">{outcomes.map((item) => <div key={item} className="rounded-2xl bg-white/10 p-4 text-sm font-semibold leading-6 text-white/85 ring-1 ring-white/10">{item}</div>)}</div>
          <div className="mt-7 rounded-2xl bg-emerald-300/10 p-5 ring-1 ring-emerald-200/20"><p className="text-sm font-black text-emerald-100">AI bruges til at stille de rigtige spørgsmål og gøre dit behov klart. Matching og tilbud kører derefter struktureret.</p></div>
        </Panel>
      </section>
