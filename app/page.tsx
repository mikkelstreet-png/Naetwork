...
<p className="text-xs font-bold tracking-widest text-gray-400 uppercase mb-6 flex items-center justify-center gap-2">
...
<Link href="/signup" className="border-2 border-gray-900 hover:bg-gray-900 hover:text-white text-gray-900 px-8 py-4 rounded-full text-sm font-semibold transition-all duration-200">
Bliv professionel
</Link>
</div>
<p className="text-xs text-gray-400 mt-8">1:1 sessions · DKK 300–2.000 · Ingen abonnement</p>
<div className="mt-12 flex justify-center">
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="text-gray-300 animate-bounce">
...
<p className="text-xs text-gray-400 leading-tight">Industrier · Banking, PE, AI, Consulting</p>
</div>
<div className="bg-gray-950 text-white rounded-2xl p-6 text-center">
<p className="text-3xl font-black mb-1">DKK 300</p>
<p className="text-xs text-gray-400 leading-tight">Laveste sessionspris</p>
</div>
<div className="bg-gray-950 text-white rounded-2xl p-6 text-center">
<p className="text-3xl font-black mb-1">15%</p>
<p className="text-xs text-gray-400 leading-tight">Platformsgebyr · 7,5% ved charity</p>
</div>
<div className="bg-gray-950 text-white rounded-2xl p-6 text-center">
<p className="text-3xl font-black mb-1">1:1</p>
<p className="text-xs text-gray-400 leading-tight">Altid personlig session</p>
</div>
</div>
</div>
</section>
