  ...
  return (
    <main className="flex min-h-[calc(100vh-4rem)] items-center bg-white px-5 py-16 sm:px-8">
      <div className="mx-auto grid w-full max-w-6xl gap-10 lg:grid-cols-[1fr_320px] lg:items-end">
        <div>
          <p className="mb-5 text-xs font-black uppercase text-gray-400">404</p>
          <h1 className="max-w-3xl text-4xl font-black leading-none text-gray-950 text-balance sm:text-5xl md:text-7xl">Siden findes ikke.</h1>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link href="/professionals" className="inline-flex items-center gap-2 rounded-lg bg-gray-950 px-5 py-3 text-sm font-black text-white hover:bg-gray-800">
              <Search size={16} aria-hidden="true" /> Se profiler
            </Link>
            <Link href="/" className="inline-flex items-center gap-2 rounded-lg border border-gray-300 px-5 py-3 text-sm font-black text-gray-950 hover:border-gray-950">
        ...
        <aside className="border-t border-gray-200 pt-6">
          ...
          <p className="mt-5 text-xl font-black text-gray-950">Har du brug for hjælp?</p>
