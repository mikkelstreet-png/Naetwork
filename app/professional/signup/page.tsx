    ...
    <main className="min-h-screen bg-[#f7f7f4] pt-16">
      <div className="mx-auto grid max-w-6xl gap-8 px-6 py-10 lg:grid-cols-[0.92fr_1.08fr] lg:py-16">
        <aside className="rounded-lg border border-gray-900 bg-gray-950 p-8 text-white shadow-2xl shadow-gray-950/10 lg:sticky lg:top-24 lg:h-fit">
          ...
          <h1 className="text-4xl font-black leading-none tracking-tight text-white text-balance">Gør din erfaring bookbar med mening.</h1>
          <p className="mt-6 max-w-md text-sm leading-relaxed text-gray-400">
            Opret en kurateret profil, vælg dine fokusområder, og sæt din pris mellem DKK 600 og 1.800 for en 60-minutters session. Hver betalt session bidrager med 40-90% til Kræftens Bekæmpelse.
          </p>
            ...
            {step === 2 && (
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <textarea value={form.bio} onChange={e => set('bio', e.target.value)} rows={4} className="w-full resize-none rounded-lg border border-gray-200 px-4 py-3 text-sm outline-none transition-colors focus:border-gray-950" placeholder="Fortæl hvad du kan hjælpe med i en 60-minutters session..." />
                </div>
              </div>
            )}
