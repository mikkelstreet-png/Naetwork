...
export default function MissionPage() {
  const principles = [
    ...
    ['Career sparring should have meaning', 'Every paid session contributes at least 40% and up to 90% of the session price to Kræftens Bekæmpelse.'],
  ];
        ...
        <div className="mx-auto max-w-6xl">
          <div className="grid gap-10 lg:grid-cols-[1fr_380px] lg:items-end">
            ...
            <div className="dark-panel p-6">
              ...
              <p className="mt-4 text-3xl font-black leading-tight">Guidance can be useful and meaningful.</p>
              <p className="mt-4 text-sm leading-relaxed text-white/60">
                Candidates get sharper career context. Every paid session also contributes at least 40% and up to 90% to Kræftens Bekæmpelse.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="px-5 py-10 sm:px-8 md:py-16">
        <div className="mx-auto grid max-w-6xl gap-6 lg:grid-cols-[0.85fr_1.15fr]">
          <aside className="premium-card p-6 md:p-8 lg:sticky lg:top-24 lg:h-fit">
            ...
            <div className="mt-8 grid gap-px overflow-hidden rounded-lg border border-gray-200 bg-gray-200">
              {['60 min format', 'Clear profile signal', 'Candidate brief', '40-90% impact'].map((item) => (
