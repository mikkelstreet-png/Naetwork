...
const required = [
  ...
  ['lib/brand.ts', /category: '60-minutters karrieresessioner'/],
  ['lib/brand.ts', /primaryLine: 'Experience you can act on\.'/],
  ['lib/brand.ts', /primaryLine: 'Erfaring, du kan handle på\.'/],
  ['lib/brand.ts', /positioning: 'Concrete career sessions with experienced professionals\.'/],
  ...
  ['components/HomeContent.tsx', /<RevenueSplit price=\{PRICE_OPTIONS\[0\]\}/],
