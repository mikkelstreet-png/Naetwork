...
const files = [
  ...
  'components/AccessHero.tsx',
  'components/ImpactMarker.tsx',
  ...
  'components/ProfessionalDetail.tsx',
  ...
  'supabase/migrations/20260716180640_session_types_and_revenue_split.sql',
  'app/admin/page.tsx',
...
const productForbidden = [
  ...
  ['generic next-level promise', /tag din karriere til næste niveau|unlock dit potentiale/i],
  ['generic networking promise', /udvid dit netværk|find din mentor|drømmekarriere/i],
  ['legacy homepage positioning', /Indsigt indefra\. Mening udadtil\.|Forstå, hvad der kræves — før det gælder\./],
]
...
const required = [
  ...
  ['lib/platform.ts', /export const CONTRIBUTION_PERCENT = 10/],
  ['lib/platform.ts', /export const PROFESSIONAL_SHARE_PERCENT = 70/],
  ['lib/brand.ts', /category: 'Den professionelle adgangsplatform'/],
  ['lib/brand.ts', /primaryLine: 'Få adgang til det, andre får gennem deres netværk\.'/],
  ['lib/brand.ts', /positioning: 'Naetwork gør professionel erfaring og dømmekraft tilgængelig/],
  ...
  ['supabase/migrations/20260716180640_session_types_and_revenue_split.sql', /contribution_percent = 10/],
  ['supabase/migrations/20260716180640_session_types_and_revenue_split.sql', /platform_share_percent = 20/],
  ['supabase/migrations/20260716180640_session_types_and_revenue_split.sql', /professional_share_percent = 70/],
  ['supabase/migrations/20260716180640_session_types_and_revenue_split.sql', /session_type IN/],
  ...
  ['components/HomeContent.tsx', /De vigtigste karrieresvar står ikke i jobopslaget\./],
  ['components/HomeContent.tsx', /Potentiale er overalt\. Adgang er det ikke\./],
  ['components/HomeContent.tsx', /60 minutter\. Ét konkret mål\. Et stærkere næste skridt\./],
  ['components/HomeContent.tsx', /Dit næste skridt behøver ikke begynde med et gæt\./],
  ['components/AccessHero.tsx', /Professionel adgang\. For alle\./],
  ['components/AccessHero.tsx', /Få adgang til det, andre får gennem deres netværk\./],
  ['components/AccessHero.tsx', /10 % af nettoprisen for hver gennemført og betalt session går til Kræftens Bekæmpelse\./],
  ['components/Navbar.tsx', /Find erfaring/],
  ['components/ProfessionalsDirectory.tsx', /Find den erfaring, du mangler\./],
  ['components/ProfessionalDetail.tsx', /Book sessionen/],
  ['components/BookingDrawer.tsx', /Betaling er ikke aktiveret endnu/],
  ['lib/publicExperience.ts', /sessionEconomics\(price\)\.contribution/],
  ['components/SituationStartContent.tsx', /Hvad skal være bedre om 60 minutter/],
