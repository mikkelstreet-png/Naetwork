...
const required = [
  ...
  ['lib/brand.ts', /category: 'Indsigt fra branchen indefra'/],
  ['lib/brand.ts', /primaryLine: 'Forstå, hvad der kræves — før det gælder\.'/],
  ['lib/brand.ts', /positioning: 'Konkret feedback fra fagpersoner/],
  ...
  ['components/HomeContent.tsx', /Hvad vil du stå stærkere i\?/],
  ['components/HomeContent.tsx', /Find den rette fagperson/],
  ['components/AccessHero.tsx', /Indsigt indefra\. Mening udadtil\./],
  ['components/AccessHero.tsx', /Forstå, hvad der kræves — før det gælder\./],
  ['components/AccessHero.tsx', /10% af hver gennemført og betalt session går til Kræftens Bekæmpelse\./],
  ['components/Navbar.tsx', /Find en fagperson/],
  ['components/ProfessionalsDirectory.tsx', /Booking sker fra den enkelte profil/],
